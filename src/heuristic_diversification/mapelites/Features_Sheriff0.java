...
public enum Features_Sheriff0 {
    ...
    EXPLORATION_NUMBER("nExplored", 0, 280, 10, false),
    DISCOVERY("nSpritesDiscovered", 0, 15, 1, false),
    SPRITES_INTERACTION("nUniqueSpriteInteractions", 0, 15, 1, false),
