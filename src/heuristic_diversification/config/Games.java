...
public enum Games {
    ...
    BUTTERFLIES(0, "butterflies", new int[]{ 206, 215, 217, 225, 235, 206}),
    ZELDA(1, "zelda", new int[]{ 64, 126, 130, 114, 138, 120, 121 }),
    DIGDUG(2, "digdug", new int[]{ 405, 405, 405, 405, 405, 405 }),
    SHERIFF(3, "sheriff", new int[]{ 280, 280, 280, 280, 280, 280 });
